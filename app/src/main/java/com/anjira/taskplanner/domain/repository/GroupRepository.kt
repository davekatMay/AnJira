...
interface GroupRepository {
    ...
    suspend fun createMeeting(groupId: Int, title: String, description: String?, dateTime: String, endDateTime: String?, location: String?, invitedUserIds: List<Int> = emptyList()): Meeting
